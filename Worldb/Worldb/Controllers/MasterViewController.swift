...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let split = splitViewController {
         ...
         //  print(UserDefaults.standard.set(false, forKey: "nightheme"))
    ...
    func setTheme() {
      //  if UserDefaults.standard.bool(forKey: "dark") {
            ...
            self.tableView.tintColor = UIColor.whithe
       // }
          //  self.tableView.backgroundView?.backgroundColor = UIColor.darkblue
